...
if verbose
    ...
    axis(ini_axis);
    title('Tin hieu tac dong nhieu Gausss 100%'); drawnow;
    difplot1(y, 0, 0, 'Khuech tan phi tuyen', verbose, ini_axis, imscale);
end
...
for i=1:nosteps
    ...
    if verbose & ~mod(i,drawstep)
        difplot1(y, dif_time, i, 'Khuech tan phi tuyen', verbose, ini_axis, imscale);
        if plotflux
